...
Route::middleware(['auth.custom','role:ROLE_ADMIN'])->group(function () {
    ...
    Route::get('/devises', [DeviController::class, 'index'])->name('devises.index');
    ...
    Route::get('/change-status-notification/{id}/{status}', [DashboardController::class, 'changeStatusNotification'])->name('change.status.notification');
